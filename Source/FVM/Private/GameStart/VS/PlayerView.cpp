...
void APlayerView::SetPlayerPositionAndFOV()
{
}
...
void APlayerView::SetPlayerInstance(APlayerView* _Player)
{
	APlayerView::M_APlayerView = _Player;
}

void APlayerView::Init_PositionAndFOV()
{
}
