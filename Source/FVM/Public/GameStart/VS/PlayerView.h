...
public:
	UPROPERTY(EditAnywhere, Category = "PlayerMapScale")
		bool bDebug = false;
	UPROPERTY(EditAnywhere, Category = "PlayerMapScale")
		FVector CurMapLocation;
public:
...
public:
	...
	UFUNCTION(BlueprintCallable)
		void SetPlayerInstance(APlayerView* _Player);

	UFUNCTION(BlueprintCallable)
		void Init_PositionAndFOV();
...
public:
	...
	//设置坐标和深度
	UFUNCTION(BlueprintCallable)
		static void SetPlayerPositionAndFOV();
};
